...
class AboutDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        description_text.setPlainText(
            ...
            "and a CLI so analysts can run guided memory forensics workflows with minimal setup.\n\n"
        ...
        github_label = QLabel('<a href="https://github.com/tears-mysthrala/Oroitz">GitHub Repository</a>')
        github_label.setOpenExternalLinks(True)
        links_layout.addWidget(github_label)
        
        docs_label = QLabel('<a href="https://github.com/tears-mysthrala/Oroitz/blob/main/docs/">Documentation</a>')
